...
\lstnewenvironment{sourcecodep}[4][]{
	\begin{adjustbox}{max width=\colwidth}%
	\noindent
	\raggedright
	\hspace{-0.082\colwidth}
...
\lstnewenvironment{sourcecode}[3][]{%
	\vspace{-\baselineskip}%
	\coreinitsourcecode{#1}{#2}{#3\vspace{-1.3\baselineskip}}%
}{%
	\ifthenelse{\equal{\showlinenumbers}{true}}{
		\leftlinenumbers}{
	}
...
\newcommand{\importsourcecode}[4][]{%
	\vspace{-\baselineskip}%
	\coreinitsourcecode{#1}{#2}{#4\vspace{-1.3\baselineskip}}%
	\lstinputlisting{#3}%
	\ifthenelse{\equal{\showlinenumbers}{true}}{%
		\leftlinenumbers}{%
	}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={0.0.3-PRES},
		Template.Version.Hash={82C327EB9DF6CA684B491FD833003F9C},
	...
	pdfproducer={Template-Presentacion v0.0.3 | (Pablo Pizarro R.) ppizarror.com},
