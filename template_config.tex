...
\def\fontdocument {raleway}        % Tipografía base, ver soportadas en manual
...
\mode<presentation> {
	...
	\definecolor{mitred}{cmyk}{0.24, 1.0, 0.78, 0.17} % #a1002f
	\definecolor{mitdarkgray}{cmyk}{0.48, 0.39, 0.39, 0.04}
	\definecolor{mitlightgray}{cmyk}{0.24, 0.20, 0.20, 0.0} % #F0F0F0
